Contributing to FASTNODE Core
============================

The FASTNODE Core project operates an open contributor model where anyone is
...
The following applies to code changes to the FASTNODE Core project, and is not to be
confused with overall FASTNODE Network Protocol consensus changes.

Whether a pull request is merged into FASTNODE Core rests with the project merge
...
Patches that change FASTNODE consensus rules are considerably more involved than
...
Where a patch set proposes to change the FASTNODE consensus, it must have been
...
The project leader is the release manager for each FASTNODE Core release.
