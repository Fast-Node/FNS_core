...
#ifndef FASTNODE_STAKEINPUT_H
#define FASTNODE_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZFNS() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zFNSStake can take two forms
// 1) the stake candidate, which is a zcmint that is attempted to be staked
// 2) a staked zfns, which is a zcspend that has successfully staked
...
public:
    ...
    bool IsZFNS() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZFNS() override { return false; }
};


#endif //FASTNODE_STAKEINPUT_H
