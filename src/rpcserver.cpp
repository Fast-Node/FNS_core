...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop FASTNODE server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "FASTNODE server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* FASTNODE features */
        {"fastnode", "masternode", &masternode, true, true, false},
        {"fastnode", "listmasternodes", &listmasternodes, true, true, false},
        {"fastnode", "getmasternodecount", &getmasternodecount, true, true, false},
        {"fastnode", "masternodeconnect", &masternodeconnect, true, true, false},
        {"fastnode", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"fastnode", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"fastnode", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"fastnode", "masternodecurrent", &masternodecurrent, true, true, false},
        {"fastnode", "masternodedebug", &masternodedebug, true, true, false},
        {"fastnode", "startmasternode", &startmasternode, true, true, false},
        {"fastnode", "createmasternodekey", &createmasternodekey, true, true, false},
        {"fastnode", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"fastnode", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"fastnode", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"fastnode", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"fastnode", "getmasternodescores", &getmasternodescores, true, true, false},
        {"fastnode", "mnbudget", &mnbudget, true, true, false},
        {"fastnode", "preparebudget", &preparebudget, true, true, false},
        {"fastnode", "submitbudget", &submitbudget, true, true, false},
        {"fastnode", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"fastnode", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"fastnode", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"fastnode", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"fastnode", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"fastnode", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"fastnode", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"fastnode", "checkbudgets", &checkbudgets, true, true, false},
        {"fastnode", "mnsync", &mnsync, true, true, false},
        {"fastnode", "spork", &spork, true, true, false},
        {"fastnode", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzfnsseed", &getzfnsseed, false, false, true},
        {"zerocoin", "setzfnsseed", &setzfnsseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzfns", &searchdzfns, false, false, true},
        {"zerocoin", "dzfnsstate", &dzfnsstate, false, false, true}
...
{
    return "> fastnode-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:47353/\n";
}
