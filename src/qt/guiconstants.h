...
/* Fastnode GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "FASTNODE"
#define QAPP_ORG_DOMAIN "fastnode.cc"
#define QAPP_APP_NAME_DEFAULT "FASTNODE-Qt"
#define QAPP_APP_NAME_TESTNET "FASTNODE-Qt-testnet"
