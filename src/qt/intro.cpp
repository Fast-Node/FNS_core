...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("FASTNODE Core"),
     ...
     * override -datadir in the fastnode.conf file in the default data directory
     * (to be consistent with fastnoded behavior)
     */
    if (dataDir != getDefaultDataDirectory())
