                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("FASTNODE Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a FASTNODE address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and fastnode: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zFNS"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About FASTNODE Core"), this);
    aboutAction->setStatusTip(tr("Show information about FASTNODE Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for FASTNODE"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your FASTNODE addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified FASTNODE addresses"));
    ...
    openAction = new QAction(QIcon(":/icons/fileicon"), tr("Open &URI..."), this);
    openAction->setStatusTip(tr("Open a FASTNODE: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the FASTNODE Core help message to get a list with possible FASTNODE command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("FASTNODE Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to FASTNODE network", "", count));
}
...
{
    QString strTitle = tr("FASTNODE Core"); // default title
