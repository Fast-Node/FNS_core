...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted FNS to zFNS");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zFNS");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received FNS from zFNS");
    case TransactionRecord::ZerocoinSpend_Change_zFns:
        return tr("Minted Change as zFNS from zFNS Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zFNS to FNS");
...
QVariant TransactionTableModel::txAddressDecoration(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::StakeZFNS:
    case TransactionRecord::MNReward:
        return QIcon(":/icons/tx_mined_mn");
    case TransactionRecord::RecvWithObfuscation:
    case TransactionRecord::RecvWithAddress:
    case TransactionRecord::RecvFromOther:
    case TransactionRecord::RecvFromZerocoinSpend:
...
QString TransactionTableModel::formatTxToAddress(const TransactionRecord* wtx, bool tooltip) const
{
    ...
    case TransactionRecord::ZerocoinMint:
    case TransactionRecord::ZerocoinSpend_Change_zFns:
        return tr("Anonymous (zFNS Transaction)");
    case TransactionRecord::StakeZFNS:
        return tr("Anonymous (zFNS Stake)");
    case TransactionRecord::SendToSelf:
    default:
