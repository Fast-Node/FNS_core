                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzFNSPathCustom = GetArg("-zfnsbackuppath", "");
    ...
    if(!strzFNSPathCustom.empty()) {
        ui->wallet_customzfnsbackuppath->setText(QString::fromStdString(strzFNSPathCustom));
        ui->wallet_customzfnsbackuppath_label->setVisible(true);
        ui->wallet_customzfnsbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzFNSPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the FASTNODE RPC console.") + "<br>" +
