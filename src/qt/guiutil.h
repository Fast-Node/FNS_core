...
/** Utility functions used by the FASTNODE Qt UI.
 */
namespace GUIUtil
{
...
// Render FASTNODE addresses in monospace font
...
// Parse "fastnode:" URI into recipient object, return true on successful parsing
