...
/**
 * FASTNODE RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzfnsseed(const UniValue& params, bool fHelp);
extern UniValue getzfnsseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzfns(const UniValue& params, bool fHelp);
extern UniValue dzfnsstate(const UniValue& params, bool fHelp);
