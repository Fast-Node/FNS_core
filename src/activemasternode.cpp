...
//
// Bootup the Masternode, look for a 10000 FASTNODE input and register on the network
//
...
vector<COutput> CActiveMasternode::SelectCoinsMasternode()
{
    ...
    BOOST_FOREACH (const COutput& out, vCoins) {
        if (obfuScationSigner.IsCollateralAmount(out.tx->vout[out.i].nValue)) { //exactly
