...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Fastnode Core fastnode-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  fastnode-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded fastnode transaction") + "\n" +
                               "  fastnode-tx [options] -create [commands]   " + _("Create hex-encoded fastnode transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded fastnode transaction
